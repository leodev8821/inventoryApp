 ...
 * @returns {Promise<{ municipio: string, provincia: string, cod_INE: string }[]>} - Una promesa que resuelve en un array de objetos, donde cada objeto contiene el nombre del municipio, la provincia y el código INE.
 *
